...
void main() {
  ...
  testWidgets('reset waits for the injected storage clear before navigating', (
    ...
    expect(
      tester.widget<Button>(find.byKey(_resetConfirmKey)).onPressed,
      isNull,
    );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final Button pendingConfirm = tester.widget<Button>(
        find.byKey(_resetConfirmKey),
      );
      expect(pendingConfirm.onPressed, isNull);
      final Button pendingClose = tester.widget<Button>(
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      try {
        ...
        for (final button in tester.widgetList<Button>(dialogButtons)) {
  ...
  testWidgets('reset confirmation ignores same-frame duplicate activation', (
    ...
    try {
      ...
      final confirm = tester
          .widget<Button>(find.byKey(_resetConfirmKey))
          .onPressed!;
      confirm();
      confirm();
      await tester.pump();
