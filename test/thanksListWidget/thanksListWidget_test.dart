...
void main() {
  group('PersonalPlanWidget Tests', () {
    final thanks = <String>['Item 1', 'Item 2', 'Item 3'];
    var tab = 0;
    ...
    testWidgets('display thanks', (tester) async {
    ...
    testWidgets('add thanks', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: ThanksListWidget(
            thanks: thanks,
      ...
      final add = find.byKey(const Key('addButton'));
      expect(add, findsWidgets);
      await tester.tap(add);
      await tester.pump();
      final editField = find.byKey(const Key('addFormTextField'));
    ...
    testWidgets('edit thanks', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: ThanksListWidget(
            thanks: thanks,
      ...
      final editButton = find.byKey(const Key('editButton3'));
    ...
    testWidgets('remove thanks', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: ThanksListWidget(
            thanks: thanks,
      ...
      final removeButton = find.byKey(const Key('removeButton3'));
    ...
    testWidgets('change Tab', (tester) async {
      ...
      expect(find.byKey(const Key('tab3')), findsWidgets);
      expect(find.byKey(const Key('tab4')), findsWidgets);
      expect(tab, 0);
      await tester.tap(find.byKey(const Key('tab4')));
      await tester.pump();
      expect(tab, 4);
      await tester.tap(find.byKey(const Key('tab3')));
      await tester.pump();
      expect(tab, 3);
    });
