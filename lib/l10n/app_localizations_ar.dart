...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String homePagePositiveTraitPopup(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'تصفّح قائمة صفاتك الإيجابية كل يوم.\nلا تتردد في إضافة المزيد — أضف بكل ثقة.',
        'female': 'تصفّحي قائمة صفاتكِ الإيجابية كل يوم.\nلا تترددي في إضافة المزيد — أضيفي بكل ثقة.',
        'other': 'تصفّح قائمة صفاتك الإيجابية كل يوم.\nلا تتردد في إضافة المزيد — أضف بكل ثقة.',
      },
    );
    return '$_temp0';
  }
  ...
  String sharePageSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'لقد أنشأت دليلاً يساعدك خلال اللحظات الصعبة!\nلنستكشف المزيد من أدوات الدعم الذاتي والمرونة النفسية',
        'female': 'لقد أنشأتِ دليلاً يساعدكِ خلال اللحظات الصعبة!\nلنستكشف المزيد من أدوات الدعم الذاتي والمرونة النفسية',
        'other': 'لقد أنشأت دليلاً يساعدك خلال اللحظات الصعبة!\nلنستكشف المزيد من أدوات الدعم الذاتي والمرونة النفسية',
      },
    );
    return '$_temp0';
  }
  ...
  String sharePageMidTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'يمكنك الآن مشاركة خطتك مع الأشخاص المقربين منك، أو تنزيلها على هاتفك',
        'female': 'يمكنكِ الآن مشاركة خطتكِ مع الأشخاص المقربين منكِ، أو تنزيلها على هاتفكِ',
        'other': 'يمكنك الآن مشاركة خطتك مع الأشخاص المقربين منك، أو تنزيلها على هاتفك',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormFirstPageSubTitle1(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'Living Positively - من أجل السعادة وتعزيز المرونة وتحسين نوعية الحياة',
        'female': 'Living Positively - من أجل السعادة وتعزيز المرونة وتحسين نوعية الحياة',
        'other': 'Living Positively - من أجل السعادة وتعزيز المرونة وتحسين نوعية الحياة',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle1(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'أنت مدعوّ لإنشاء خطة شخصية تقدم الدعم خلال اللحظات الصعبة، لك ولمن حولك.',
        'female': 'أنتِ مدعوّة لإنشاء خطة شخصية تقدم الدعم خلال اللحظات الصعبة، لكِ ولمن حولكِ.',
        'other': 'أنت مدعوّ لإنشاء خطة شخصية تقدم الدعم خلال اللحظات الصعبة، لك ولمن حولك.',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle2(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'يُنصح بقضاء بضع دقائق الآن للتعامل بشكل أفضل مع التحديات المستقبلية.',
        'female': 'يُنصح بقضاء بضع دقائق الآن للتعامل بشكل أفضل مع التحديات المستقبلية.',
        'other': 'يُنصح بقضاء بضع دقائق الآن للتعامل بشكل أفضل مع التحديات المستقبلية.',
      },
    );
    return '$_temp0';
  }
  ...
  String feelBetterHeader(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'ما الذي يمكنني فعله لمساعدة نفسي على تحقيق التوازن والحفاظ على نمط حياة صحي (أدوات العافية) - الأدوية الشخصية',
        'female': 'ما الذي يمكنني فعله لمساعدة نفسي على تحقيق التوازن والحفاظ على نمط حياة صحي (أدوات العافية) - الأدوية الشخصية',
        'other': 'ما الذي يمكنني فعله لمساعدة نفسي على تحقيق التوازن والحفاظ على نمط حياة صحي (أدوات العافية) - الأدوية الشخصية',
      },
    );
    return '$_temp0';
  }
  ...
  String feelBetterSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'ما الذي يساعدني على تحسين حالتي المزاجية والاسترخاء والشعور بقدر أقل من التوتر؟\nأساليب وقائية يومية، وحتى زيادة الجرعات في حالات الطوارئ.',
        'female': 'ما الذي يساعدني على تحسين حالتي المزاجية والاسترخاء والشعور بقدر أقل من التوتر؟\nأساليب وقائية يومية، وحتى زيادة الجرعات في حالات الطوارئ.',
        'other': 'ما الذي يساعدني على تحسين حالتي المزاجية والاسترخاء والشعور بقدر أقل من التوتر؟\nأساليب وقائية يومية، وحتى زيادة الجرعات في حالات الطوارئ.',
      },
    );
    return '$_temp0';
  }
  ...
  String makeSaferHeader(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'الدعم والمساعدة من محيطي عندما أختبر علامات الإنذار المبكرة، وكيف أود أن أتلقى المساعدة',
        'female': 'الدعم والمساعدة من محيطي عندما أختبر علامات الإنذار المبكرة، وكيف أود أن أتلقى المساعدة',
        'other': 'الدعم والمساعدة من محيطي عندما أختبر علامات الإنذار المبكرة، وكيف أود أن أتلقى المساعدة',
      },
    );
    return '$_temp0';
  }
  ...
  String phonesPageHeader(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'من هم الأشخاص الذين يدعمونني ويمكنني اللجوء إليهم إذا كنت في ضيق أو تراودني أفكار لإيذاء نفسي؟',
        'female': 'من هم الأشخاص الذين يدعمونني ويمكنني اللجوء إليهم إذا كنت في ضيق أو تراودني أفكار لإيذاء نفسي؟',
        'other': 'من هم الأشخاص الذين يدعمونني ويمكنني اللجوء إليهم إذا كنت في ضيق أو تراودني أفكار لإيذاء نفسي؟',
      },
    );
    return '$_temp0';
  }
  ...
  String phonePageTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'أنت لست وحدك! إذا كنت في محنة الآن، يرجى التواصل مع إحدى جهات الاتصال المذكورة هنا',
        'female': 'أنتِ لستِ وحدكِ! إذا كنتِ في محنة الآن، يرجى التواصل مع إحدى جهات الاتصال المذكورة هنا',
        'other': 'أنت لست وحدك! إذا كنت في محنة الآن، يرجى التواصل مع إحدى جهات الاتصال المذكورة هنا',
      },
    );
    return '$_temp0';
  }
  ...
  String feelGoodSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'يوصى بإضافة صور مشجعة وملهمة ومبهجة. صور مبتسمة للعائلة والأصدقاء والهوايات والرحلات الناجحة والمزيد',
        'female': 'يوصى بإضافة صور مشجعة وملهمة ومبهجة. صور مبتسمة للعائلة والأصدقاء والهوايات والرحلات الناجحة والمزيد',
        'other': 'يوصى بإضافة صور مشجعة وملهمة ومبهجة. صور مبتسمة للعائلة والأصدقاء والهوايات والرحلات الناجحة والمزيد',
      },
    );
    return '$_temp0';
  }
  ...
  String feelBetterListNo17(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'أخذ قسط من الراحة بتغيير مكاني (على سبيل المثال، الانتقال إلى غرفة أخرى في المنزل)',
        'female': 'أخذ قسط من الراحة بتغيير مكاني (على سبيل المثال، الانتقال إلى غرفة أخرى في المنزل)',
        'other': 'أخذ قسط من الراحة بتغيير مكاني (على سبيل المثال، الانتقال إلى غرفة أخرى في المنزل)',
      },
    );
    return '$_temp0';
  }
