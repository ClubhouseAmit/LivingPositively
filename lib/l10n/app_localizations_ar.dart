...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String introductionFormLastPageSubTitle1Line1(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'الخطط تمنحك الثبات عندما تبدو الأمور غير مؤكدة.',
        'female': 'الخطط تمنحك الثبات عندما تبدو الأمور غير مؤكدة.',
        'other': 'الخطط تمنحك الثبات عندما تبدو الأمور غير مؤكدة.',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle1Line2(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'ابنِ خطتك في وقتك الخاص.',
        'female': 'ابنِ خطتك في وقتك الخاص.',
        'other': 'ابنِ خطتك في وقتك الخاص.',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageAccordion2Header(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'لماذا نستعد الآن؟',
        'female': 'لماذا نستعد الآن؟',
        'other': 'لماذا نستعد الآن؟',
      },
    );
    return '$_temp0';
  }
  ...
  String feelBetterHeader(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        ...
        'female':
            'لتحقيق التوازن ونمط حياة صحي - أدوات العافية والأدوية الشخصية',
        'other':
            'لتحقيق التوازن ونمط حياة صحي - أدوات العافية والأدوية الشخصية',
      },
    );
  ...
  @override
  String get affirmationCardLabel => 'تذكير';

  @override
  String get nextAffirmationTooltip => 'التذكير التالي';
