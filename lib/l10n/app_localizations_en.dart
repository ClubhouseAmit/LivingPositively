...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String otherSuggestions(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'Get inspiration',
        'female': 'Get inspiration',
        'other': 'Get inspiration',
      },
    );
    return '$_temp0';
  }
  ...
  String homePageTraitsSecondaryTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'What I\'m good at, read daily',
        'female': 'What I\'m good at, read daily',
        'other': 'What I\'m good at, read daily',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle1Line1(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'A plan gives you steadiness when things feel uncertain.',
        'female': 'A plan gives you steadiness when things feel uncertain.',
        'other': 'A plan gives you steadiness when things feel uncertain.',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle1Line2(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'Build yours, in your own time.',
        'female': 'Build yours, in your own time.',
        'other': 'Build yours, in your own time.',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageAccordion2Header(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'Why Prepare Now?',
        'female': 'Why Prepare Now?',
        'other': 'Why Prepare Now?',
      },
    );
    return '$_temp0';
  }
  ...
  String feelGoodTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'Mood-Boosting Images',
        'female': 'Mood-Boosting Images',
        'other': 'Mood-Boosting Images',
      },
    );
    return '$_temp0';
  }
  ...
  @override
  String get affirmationCardLabel => 'A reminder';

  @override
  String get nextAffirmationTooltip => 'Next reminder';
