...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get personalPlanInfoRecommendation =>
      'ההמלצה שלנו: כדאי למלא את התוכנית כעת, מתוך מקום של רוגע, ולשתף אותה בקלות עם אדם אהוב – כדי שתמיד תרגישו עטופים ומוכנים. אפשר למלא את התוכנית באופן עצמאי או בעזרה משותפת, ומומלץ לעדכן אותה מידי פעם, וכמובן לשתף אותה עם מי שמתאים.';
