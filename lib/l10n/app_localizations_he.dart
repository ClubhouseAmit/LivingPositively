...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String introductionFormLastPageSubTitle1Line1(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'אל תחכה לרגעים קשים - צור כבר עכשיו את התוכנית האישית שלך',
        'female': 'אל תחכי לרגעים קשים - צרי כבר עכשיו את התוכנית האישית שלך',
        'other': 'אל תחכה לרגעים קשים - צור כבר עכשיו את התוכנית האישית שלך',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageSubTitle1Line2(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'כדי להגן על השקט הנפשי שלך ולתמוך באנשים היקרים לך',
        'female': 'כדי להגן על השקט הנפשי שלך ולתמוך באנשים היקרים לך',
        'other': 'כדי להגן על השקט הנפשי שלך ולתמוך באנשים היקרים לך',
      },
    );
    return '$_temp0';
  }
  ...
  String introductionFormLastPageAccordion2Header(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'למה להתכונן עכשיו?',
        'female': 'למה להתכונן עכשיו?',
        'other': 'למה להתכונן עכשיו?',
      },
    );
    return '$_temp0';
  }
  ...
  @override
  String get affirmationCardLabel => 'תזכורת';

  @override
  String get nextAffirmationTooltip => 'תזכורת הבאה';
