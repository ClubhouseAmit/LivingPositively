...
part 'mood_medicine_misc_helpers.dart';
part 'mood_medicine_check_in_helper.dart';
part 'mood_medicine_insights_helper.dart';
part 'mood_medicine_export_helper.dart';
...
class _MoodMedicinePageState extends State<MoodMedicinePage> {
  ...
  Widget _buildCheckIn(AppLocalizations l10n, MoodMedicineReadyState ready) =>
      buildMoodMedicineCheckIn(this, l10n, ready);
